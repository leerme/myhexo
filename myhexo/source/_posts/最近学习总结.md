...
![首页无CSS](../images/5nocss1.png)
![增加页无CSS](../images/5nocss2.png)

#### 1.2 CSS 
哈哈是不是太丑了，那肯定不是有三个星期CSS功力的我写的页面，简单的加入点CSS样式之后，这才是我写的。

![首页CSS](../images/5css1.png)
![增加页CSS](../images/5css2.png)
...
第三步 查看node安装成功与否
node -v 
![查看是否验证安装node](../images/5nodeVersion.png)
...
增加操作：
![Demo演示](../images/5add.gif)

删除操作：
![Demo演示](../images/5delete.gif)
